...
const auto kAllPerfTasks =
    std::tuple_cat(ppc::util::MakeAllPerfTasks<InType, TerekhovDGaussVertSEQ>(PPC_SETTINGS_terekhov_d_seq_gauss_vert),
                   ppc::util::MakeAllPerfTasks<InType, TerekhovDGaussVertOMP>(PPC_SETTINGS_terekhov_d_seq_gauss_vert));
